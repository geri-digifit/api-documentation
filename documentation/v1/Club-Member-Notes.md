...
|note_type|string|`general`, `coaching`, `products`, `invoices`, `files`, `checkup`|The type of the note.|
...
|note_type|no|Can only be one of `general`, `coaching`, `products`, `invoices`, `files`, `checkup`|
...
|note_type|yes (if note_text set)|Can only be one of `general`, `coaching`, `products`, `invoices`, `files`, `checkup`|
