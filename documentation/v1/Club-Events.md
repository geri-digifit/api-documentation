...
|---|---|---|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|GET|/api/v1/club/`<club_id>`/events/|Returns events of the club based on queries supplied| api_key, club_secret, sync_from (timestamp in milliseconds), timestamp_start (timestamp in seconds, optional), timestamp_end (timestamp in seconds, optional), member_id (optional), schedule_id (optional) |
