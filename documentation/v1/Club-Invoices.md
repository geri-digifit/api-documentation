...
|GET|/api/v1/club/`<club_id>`/invoices/|Returns all invoices (max 500 per page)|api_key, club_secret|
...
|extra_invoice_field_1|string|yes|String value for the second extra invoice field - GET only|
|extra_invoice_field_2|string|yes|String value for the second extra invoice field - GET only|
|extra_invoice_field_3|string|yes|String value for the second extra invoice field - GET only|
|employee_extra_field|string|yes|String value for the employee extra invoice field - GET only|
...
```json
{
    ...
    "result": {
        ...
        "extra_invoice_field_1": "Corporate Client",
        "rows": [
            {
